                        ...
                        panel7Layout.createParallelGroup()
                            .addGroup(panel7Layout.createSequentialGroup()
                                ...
                                .addGroup(panel7Layout.createParallelGroup()
                                    ...
                                    .addComponent(scrollPane1, GroupLayout.DEFAULT_SIZE, 688, Short.MAX_VALUE))
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                        ...
                        panel17Layout.createParallelGroup()
                            .addGroup(GroupLayout.Alignment.TRAILING, panel17Layout.createSequentialGroup()
                                ...
                                .addGroup(panel17Layout.createParallelGroup()
                                    ...
                                    .addGroup(panel17Layout.createSequentialGroup()
                                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(scrollPane5, GroupLayout.PREFERRED_SIZE, 681, GroupLayout.PREFERRED_SIZE)
                                        .addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                    );
        ...
        layout.setHorizontalGroup(
            layout.createParallelGroup()
                .addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                    ...
                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(tabbedPane1, GroupLayout.PREFERRED_SIZE, 971, GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup()
                ...
                .addGroup(layout.createSequentialGroup()
                    ...
                    .addGap(18, 18, 18)
                    .addComponent(tabbedPane1, GroupLayout.PREFERRED_SIZE, 417, GroupLayout.PREFERRED_SIZE)
