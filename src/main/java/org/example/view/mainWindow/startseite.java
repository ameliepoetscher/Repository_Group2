    ...
    private void ladeHotelsInTabelle() {
        ...
        for (Hotel hotel : hotels) {
            Object[] rowData = {
                    ...
                    hotel.getLastTransactionalData() != null ? hotel.getLastTransactionalData() : "" // bleibt leer, wenn null
            };
            model.addRow(rowData);
        }
        table1.setModel(model);

        // transactionalDataAlt befüllen mit aktuellem Attributwert (NICHT lastTransactionalData)
        ...
        try {
            ...
            for (int i = 0; i < model.getRowCount(); i++) {
                ...
                if (!attribute.equals(attributeAlt)) {
                    ...
                    // Attribut-Alt auch updaten, damit weitere Saves nicht direkt wieder ein neues Datum machen
                    transactionalDataAlt.put(i, attribute);
                } else if (lastTransactionalData == null || lastTransactionalData.equals("2025-06-22")) {
                    // Wenn kein Change, dann Feld leer lassen!
                    lastTransactionalData = "";
                    model.setValueAt(lastTransactionalData, i, 9);
                }
